...
def test_init_with_checker_creates_choices_with_prefix():
    ...
    expected_choices = [
        ("name", "name"),
        ("id", "id"),
        ("flex_fields__prefix1_field1", "prefix1: Field One (prefix1_field1)"),
        ("flex_fields__prefix2_field2", "prefix2: Field Two (prefix2_field2)"),
    ]
...
def test_init_with_checker_field_without_label_uses_field_name():
    ...
    expected_choices = [
        ("name", "name"),
        ("id", "id"),
        ("flex_fields__test_field_without_label", "test: field_without_label (test_field_without_label)"),
    ]
...
def test_init_with_checker_field_with_empty_label_uses_field_name():
    ...
    expected_choices = [
        ("name", "name"),
        ("id", "id"),
        ("flex_fields__test_field_with_empty_label", "test: field_with_empty_label (test_field_with_empty_label)"),
    ]
...
def test_init_with_checker_field_with_none_label_uses_field_name():
    ...
    expected_choices = [
        ("name", "name"),
        ("id", "id"),
        ("flex_fields__test_field_with_none_label", "test: field_with_none_label (test_field_with_none_label)"),
    ]
...
def test_init_with_checker_creates_choices_with_prefix_and_household_field():
    ...
    expected_choices = [
        ...
        ("id", "id"),
        ("household", "household"),
        ("flex_fields__ind_individual_field", "ind: Individual Field (ind_individual_field)"),
    ]
